...
# modified to create a mailalias for graduate student committee reps from sitedb - James Brunt 2/8/11	 
#
...
$sql = "SELECT DISTINCT  site_id_text, grad_rep
FROM  ltersites"; 
...
$sql2 = "UPDATE person_group SET personid = $gradrep WHERE groupid = 36 AND site = '$site' AND status = 1";
#print $sql2 . "\n";
$sql3 = "Select count(*) from person_group where personid= $gradrep AND groupid= 270";
#print $sql3 . "\n";
$sql4 = "INSERT INTO person_group ( personid, groupid, status ) VALUES ($gradrep, 270, 1)";
#print $sql4 . "\n";
