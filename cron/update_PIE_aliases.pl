...
#modifed to create grad list for PIE - James 5/24/2015
...
WHERE LTER.dbo.person.status !=4 AND (LTER.dbo.ltertable.primarysite = '311' and
...
$sql2 = "UPDATE LTER.dbo.person_group SET personid = $person WHERE groupid = 311 AND site = 'PIE'";
#print $sql2 . "\n";
$sql3 = "Select count(*) from LTER.dbo.person_group where personid= $person AND groupid= 311";
#print $sql3 . "\n";
$sql4 = "INSERT INTO LTER.dbo.person_group ( personid, groupid, status ) VALUES ($person, 311, 1)";
#print $sql4 . "\n";
