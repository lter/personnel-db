...
my $sql = "SELECT LTER.dbo.person.firstname ,LTER.dbo.person.lastname, 
   LTER.dbo.person.primaryemail, LTER.dbo.person_group.groupid FROM LTER.dbo.person 
   ...
   WHERE (LTER.dbo.person_group.groupid = 240 ) ORDER BY LTER.dbo.person.lastname"; 

   open my $fh, '>', \$variable or die "Can't open variable: $!";
   print $fh "<h1>This is the LTER NSF email list (nsf-lter\@lternet.edu) for your review</h1>";
print $fh "<ul>";
...
print $fh "<li>" . $firstname . " " . $lastname . ", " . $primaryemail . "\n";
}
 ...
 use Mail::Sender;
        ...
        eval {
                ...
                ->OpenMultipart({
                        ...
                        subject => 'Monthly LTER NSF Email List Review',
