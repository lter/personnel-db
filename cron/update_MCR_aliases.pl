...
#modifed to create grad list for MCR - James 5/25/2015
...
WHERE LTER.dbo.person.status !=4 AND (LTER.dbo.ltertable.primarysite = 'MCR' and
...
$sql2 = "UPDATE LTER.dbo.person_group SET personid = $person WHERE groupid = 195 AND site = 'MCR'";
#print $sql2 . "\n";
$sql3 = "Select count(*) from LTER.dbo.person_group where personid= $person AND groupid= 195";
#print $sql3 . "\n";
$sql4 = "INSERT INTO LTER.dbo.person_group ( personid, groupid, status ) VALUES ($person, 195, 1)";
#print $sql4 . "\n";
