...
WHERE LTER.dbo.person.status !=4 AND (LTER.dbo.ltertable.primarysite = 'SEV' and
LTER.dbo.ltertable.primaryrole = 'GS')
ORDER BY LTER.dbo.person.lastname";


#$sql = "SELECT personid
#FROM  LTER.dbo.ltertable where primarysite = 'SEV' and primaryrole = 'GS'"; 
...
$sql2 = "UPDATE LTER.dbo.person_group SET personid = $person WHERE groupid = 304 AND site = 'SEV'";
#print $sql2 . "\n";
$sql3 = "Select count(*) from LTER.dbo.person_group where personid= $person AND groupid= 304";
#print $sql3 . "\n";
$sql4 = "INSERT INTO LTER.dbo.person_group ( personid, groupid, status ) VALUES ($person, 304, 1)";
#print $sql4 . "\n";
