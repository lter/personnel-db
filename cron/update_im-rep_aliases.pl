...
# modified to create a mailalias for IM committee reps from sitedb - James Brunt 2/8/11	 
#
...
$sql = "SELECT DISTINCT  site_id_text, information_manager
FROM  ltersites"; 
...
$sql2 = "UPDATE person_group SET personid = $imrep WHERE groupid = 155 AND site = '$site'";
#print $sql2 . "\n";
$sql3 = "Select count(*) from person_group where personid= $imrep AND groupid= 155";
#print $sql3 . "\n";
$sql4 = "INSERT INTO person_group ( personid, groupid, status, site ) VALUES ($imrep, 155, 1, '$site')";
#print $sql4 . "\n";
