...
$sql = "SELECT DISTINCT  site_id_text, climate_rep
FROM  ltersites"; 
...
$sql2 = "UPDATE person_group SET personid = $climrep WHERE groupid = 241 AND site = '$site'";
#print $sql2 . "\n";
$sql3 = "Select count(*) from person_group where personid= $climrep AND groupid= 27";
#print $sql3 . "\n";
$sql4 = "INSERT INTO person_group ( personid, groupid, status ) VALUES ($climrep, 27, 1)";
#print $sql4 . "\n";
