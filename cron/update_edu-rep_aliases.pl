...
# modified to create a mailalias for education committee reps from sitedb - James Brunt 9/24/10	 
#
...
$sql = "SELECT DISTINCT  site_id_text, education_contact
FROM  ltersites"; 
...
$sql2 = "UPDATE person_group SET personid = $edurep WHERE groupid = 266 AND site = '$site'";
#print $sql2 . "\n";
$sql3 = "Select count(*) from person_group where personid= $edurep AND groupid= 116";
#print $sql3 . "\n";
$sql4 = "INSERT INTO person_group ( personid, groupid, status ) VALUES ($edurep, 116, 1)";
#print $sql4 . "\n";
